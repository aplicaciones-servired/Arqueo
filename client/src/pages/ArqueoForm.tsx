          ...
          <Card key={index} className='dark:bg-dark-tremor-brand-muted dark:text-white'>
            ...
            <div className="grid grid-cols-4 gap-4 mt-5">
              ...
              <div className="flex flex-col items-center">
                {arqueo.imagen_observacion != null && arqueo.imagen_observacion.length < 1000000 && (
                  <>
              ...
              {/* Firma Auditoria */}
              <div className="flex flex-col items-center">
                {arqueo.firma_auditoria != null && arqueo.firma_auditoria.length < 1000000 && (
                  <>
              ...
              {/* Firma Colocadora */}
              <div className="flex flex-col items-center">
                {arqueo.firma_colocadora != null && arqueo.firma_colocadora.length < 1000000 && (
                  <>
